...
SELECT  t.APTransKey                                                                                                AS [AP trans key]
  ...
  , 1                                                                                                           AS [Trans count]
FROM {{ ref("d365cma_aptrans_f") }}         t
LEFT JOIN {{ ref("d365cma_ledgertranstype_d") }} lt 
  ON lt.LedgerTransTypeKey  = t.LedgerTransTypeKey
LEFT JOIN {{ ref("d365cma_currency_d") }}        cy 
  ON cy.CurrencyKey         = t.CurrencyKey
LEFT JOIN {{ ref("d365cma_employee_d") }}        e 
...
LEFT JOIN {{ ref("d365cma_purchaseinvoice_d") }} pui 
...
LEFT JOIN {{ ref("d365cma_checkstatus_d") }}     cs 
