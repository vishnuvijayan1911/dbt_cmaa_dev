...
AS (
  SELECT  pilcf.PurchaseInvoiceLineTransKey
    ...
    FROM {{ ref("d365cma_purchaseinvoicelinechargetrans_f") }} pilcf  
    LEFT JOIN {{ ref("d365cma_purchaseinvoicelinecharge_f") }} pilc  
...
FROM {{ ref("d365cma_purchaseinvoicelinetrans_f") }} piltf  
INNER JOIN {{ ref("d365cma_purchaseinvoiceline_f") }} pilf  
