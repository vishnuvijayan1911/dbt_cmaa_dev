{{ config(materialized='view', schema='gold', alias="Purchase order line (open) fact") }}
...
FROM {{ ref("d365cma_purchaseorderline_f") }}    t 
JOIN {{ ref("d365cma_purchasetype_d") }}              st 
...
LEFT JOIN {{ ref("d365cma_purchasetype_d") }}         pt1
