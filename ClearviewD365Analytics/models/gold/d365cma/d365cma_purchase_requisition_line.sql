...
SELECT  t.PurchaseRequisitionLineKey AS [Purchase requisition line key]
  ...
  FROM {{ ref("d365cma_purchaserequisitionline_d") }}           t 
INNER JOIN {{ ref("d365cma_purchaserequisitionline_f") }} f 
