{{ config(materialized='view', schema='gold', alias="RAF journal shift fact") }}
...
FROM {{ ref("d365cma_productionfinishedjournal_f") }} t
    LEFT JOIN {{ ref("d365cma_rafjournalshift_f") }} s
