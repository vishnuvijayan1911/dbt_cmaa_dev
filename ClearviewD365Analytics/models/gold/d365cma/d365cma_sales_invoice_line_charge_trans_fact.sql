...
SELECT  t.SalesInvoiceLineTransKey                                                           AS [Sales invoice line trans key]
  ...
  FROM {{ ref("d365cma_salesinvoicelinechargetrans_f") }} t
  LEFT JOIN {{ ref("d365cma_salesinvoicelinetrans_f") }}  silt 
  ...
  LEFT JOIN {{ ref("d365cma_salesinvoicelinecharge_f") }} solc 
    ON solc.SalesInvoiceLineChargeKey = t.SalesInvoiceLineChargeKey
  LEFT JOIN {{ ref("d365cma_chargecode_d") }}                  cc 
