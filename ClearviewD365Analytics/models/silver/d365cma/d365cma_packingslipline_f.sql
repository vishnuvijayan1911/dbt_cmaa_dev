...
packingslipline_factline AS (
    SELECT dcu.CustomerKey                                                   AS CustomerKey
         ...
         INNER JOIN {{ ref('d365cma_packingslipline_d') }}   dcpl
          ...
          LEFT JOIN {{ ref('d365cma_lot_d') }}               dl
          ...
          LEFT JOIN {{ ref('d365cma_vwuomconversion') }}   vuc1
