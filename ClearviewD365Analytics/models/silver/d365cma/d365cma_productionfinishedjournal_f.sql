{{ config(materialized='table', tags=['silver'], alias='productionfinishedjournal_fact') }}

-- Source file: cma/cma/layers/_base/_silver/productionfinishedjournal_f/productionfinishedjournal_f.py
