...
purchaseinvoicelinechargetrans_facttrans AS (
    SELECT fc.PurchaseInvoiceLineChargeKey
        ...
        FROM {{ ref('d365cma_purchaseinvoicelinecharge_f') }} fc
...
purchaseinvoicelinechargetrans_factadj AS (
    SELECT t.PurchaseInvoiceLineChargeKey
         ...
         INNER JOIN {{ ref('d365cma_purchaseinvoicelinecharge_f') }} fcl
...
SELECT DISTINCT
      ...
      LEFT JOIN {{ ref('d365cma_purchaseinvoicelinetrans_f') }} pilt
