{{ config(materialized='table', tags=['silver'], alias='purchaseorderlinetaxtrans_fact') }}

-- Source file: cma/cma/layers/_base/_silver/purchaseorderlinetaxtrans_f/purchaseorderlinetaxtrans_f.py
...
SELECT DISTINCT
      ...
      FROM {{ ref('d365cma_purchaseorderlinetax_f') }}        ft
     ...
     INNER JOIN purchaseorderlinetaxtrans_factpolratio                       tr
      ...
      LEFT JOIN {{ ref('d365cma_purchaseorderlinetrans_f') }} fclt
