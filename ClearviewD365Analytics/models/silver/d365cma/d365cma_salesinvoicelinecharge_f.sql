{{ config(materialized='table', tags=['silver'], alias='salesinvoicelinecharge_fact') }}

-- Source file: cma/cma/layers/_base/_silver/salesinvoicelinecharge_f/salesinvoicelinecharge_f.py
...
salesinvoicelinecharge_factdetail1 AS (
    SELECT dc.ChargeCodeKey                                                    AS ChargeCodeKey
         ...
         INNER JOIN {{ ref('d365cma_legalentity_d') }}       le
          ...
          LEFT JOIN {{ ref('d365cma_salesinvoiceline_d') }}  dsil
