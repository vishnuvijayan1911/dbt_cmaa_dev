{{ config(materialized='table', tags=['silver'], alias='salesorderlinetaxtrans_fact') }}

-- Source file: cma/cma/layers/_base/_silver/salesorderlinetaxtrans_f/salesorderlinetaxtrans_f.py
...
SELECT DISTINCT
      ...
      FROM {{ ref('d365cma_salesorderlinetax_f') }}           ft
     ...
     INNER JOIN salesorderlinetaxtrans_factsolratio                       tr
      ...
      LEFT JOIN {{ ref('d365cma_salesorderlinetrans_f') }} fclt
