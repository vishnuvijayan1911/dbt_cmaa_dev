...
salesorderlinetrans_factuomconversion AS (
    SELECT tr.PhysicalReservedQuantity									  AS PhysicalReservedQuantity
      ...
      INNER JOIN {{ ref('d365cma_salesorderline_f') }} sol
    ...
    --  AND vuc2.touom          = 'LB'
        LEFT JOIN {{ ref('d365cma_vwuomconversion_pc') }}     vuc5
...
salesorderlinetrans_facttrans AS (
    ...
    INNER JOIN {{ ref('d365cma_salesorderline_f') }} fsl
...
salesorderlinetrans_factprorate AS (
    ...
    ORDER BY ISNULL(ts.RecID_IT, 0)) = 1
            ...
            , ts._SourceDate
          FROM {{ ref('d365cma_salesorderline_f') }} fsl
...
salesorderlinetrans_factadj AS (
    ...
    INNER JOIN {{ ref('d365cma_salesorderline_f') }} fcl
...
salesorderlinetrans_factdetail1 AS (
    ...
    LEFT JOIN {{ ref('d365cma_inventory_trans_status_d') }} ds
