{{ config(materialized='table', tags=['silver'], alias='transferorderline_fact') }}

-- Source file: cma/cma/layers/_base/_silver/transferorderline_f/transferorderline_f.py
...
transferorderline_factdetailmain AS (
    SELECT t.transferorderlinekey        AS TransferOrderLinekey
     ...
     INNER JOIN {{ ref('d365cma_transferorderline_d') }} t
