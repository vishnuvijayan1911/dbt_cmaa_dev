...
packingslipline_factline AS (
    SELECT dcu.CustomerKey                                                   AS CustomerKey
         ...
         INNER JOIN {{ ref('packingslipline_d') }}   dcpl
          ...
          LEFT JOIN {{ ref('shippingload_d') }}      dsl
