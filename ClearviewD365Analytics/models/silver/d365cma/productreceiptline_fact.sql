...
-- Source file: cma/cma/layers/_base/_silver/productreceiptline_fact/productreceiptline_fact.py
...
productreceiptline_factdetailmain AS (
    SELECT dpl.ProductReceiptLineKey
         ...
         INNER JOIN silver.cma_ProductReceiptLine dpl
          ...
          LEFT JOIN silver.cma_PurchaseType       pt
