...
-- Source file: cma/cma/layers/_base/_silver/purchaseorder_fact/purchaseorder_fact.py
...
purchaseorder_factdetailmain AS (
    SELECT dpo.PurchaseOrderKey                                                                   AS PurchaseOrderKey
         ...
         INNER JOIN silver.cma_PurchaseOrder        dpo
            ON dpo._RecID              = ts._RecID
           AND dpo._SourceID           = 1
         INNER JOIN silver.cma_LegalEntity          le
            ON le.LegalEntityID        = ts.LegalEntityID
          LEFT JOIN silver.cma_BuyerGroup           bg
          ...
          LEFT JOIN silver.cma_DocumentState        dst
